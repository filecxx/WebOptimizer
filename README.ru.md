...
Разблокируйте ограничения, защитите свою конфиденциальность, удалите раздражающие элементы, автоклики и замените нелюбимые слова.
...
# Запрос на добавление функции && Вклад

Нет необходимости создавать новое расширение для браузера на основе этого проекта.

Если у вас есть запрос на добавление функции, просто опубликуйте проблему.

Кроме того, вы можете поместить свой код в этот репозиторий, и он будет объединен с основной веткой.
